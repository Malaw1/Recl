...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('img/laborex.jfif')}}"/>

    <title>Suivi des erreurs | Authentification</title>
...
<body class="text-center">
    <form method="POST" action="{{ route('login') }}" class="needs-validation form-signin" novalidate="" >
        @csrf
        <img class="mb-4" src="{{ asset('img/laborex.jfif') }}" alt="" width="72" height="72">
        ...
        <p class="mt-5 mb-3 text-muted">&copy;DSI-Laborex 2022</p>
    </form>
</body>
</html>


Route::get("data", .Controller::class, 'function'.)